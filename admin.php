...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="./admin/data-user.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="./admin/data-siswa.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="./admin/data-guru.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="./admin/data-kelas.php">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-link">
                                <span class="mr-2 d-none d-inline text-gray-600"> <?= $data['level'] ?> </span>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-inline text-gray-600"> <?= $data['username'] ?> </span>
                ...
                <div class="container-fluid" style="min-height: 450px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="./admin/data-user.php" class="nav-link">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sqlc = mysqli_query($conn, "SELECT * FROM user");
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sqls = mysqli_query($conn, "SELECT * FROM data_siswa");
                                                    $s = mysqli_num_rows($sqls);
                                                    echo $s;
                                                    ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sqlg = mysqli_query($conn, "SELECT * FROM data_guru");
                                                    $g = mysqli_num_rows($sqlg);
                                                    echo $g;
                                                    ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sqlk = mysqli_query($conn, "SELECT * FROM kelas");
                                                    $k = mysqli_num_rows($sqlk);
                                                    echo $k;
                                                    ?>
                                                </div>
                                            </div>
