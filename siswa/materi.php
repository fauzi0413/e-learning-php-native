                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="card shadow mb-4">
                                        <div class="card-header row mx-0 py-3">
                                            <span class="h4">Kumpulan materi</span>
                                        </div>
                                        <div class="card-body">
                                            <?php
                                            ?>
                                            ...
                                            <div class="content">
                                                <?php
                                                $sql_materi = mysqli_query($conn, "SELECT * FROM materi WHERE kelas = '$siswa[kelas_siswa]' ORDER BY tanggal_unggah DESC ");
                                                while ($data_materi = mysqli_fetch_assoc($sql_materi)) {
                                                ?>

                                                    <a href="./view.php?cek=materi&id=<?= $data_materi['id'] ?>" class="btn btn-light w-100 mb-3" style="border-radius: 10px;">
                                                        <div class="float-left">
                                                            <span class=""><?= $data_materi['judul_materi'] ?></span>
                                                            <span>||</span>
